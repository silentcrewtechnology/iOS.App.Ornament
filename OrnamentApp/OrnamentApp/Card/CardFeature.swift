...
final class CardFeature: FeatureProtocol {
    
    deinit {
        print("💀 удалился CardFeature")
    }
...
extension CardFeature {
    ...
    private func createAllProperties() -> CardViewController.ViewProperties {
        // Здесь создаем все View Entities, которые входят в экран
        let property = CardViewController.ViewProperties()
        return property
    }
}
